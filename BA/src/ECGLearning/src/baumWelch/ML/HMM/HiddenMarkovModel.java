...
import ECGLearning.src.baumWelch.SA.Statistics.StatisticalOperations;
...
public class HiddenMarkovModel {
	...
	/**
	 * Estimate the parameters of HMM which known as the learning approach for
	 * HMM
	 * 
	 * @param states
	 *            A Vector which is the model states
	 ...
	 *            A boolean which indicates if the function will use the
	 *            smoothing value or not to avoid zero values.
	 */
