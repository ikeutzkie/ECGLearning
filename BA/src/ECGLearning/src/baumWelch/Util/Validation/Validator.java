package ECGLearning.src.baumWelch.Util.Validation;
...
public class Validator {
	...
	public boolean isValidTransitionMatrix(Hashtable<Pair<String, String>, Double> transitionMatrix,
	...
	public boolean isValidEmissionMatrix(Hashtable<Pair<String, String>, Double> emissionMatrix, Vector<String> states,
