package ECGLearning.src.baumWelch.SA.Statistics;
...
public class StatisticalOperations {
	 ...
	 * 
	 * @param probabilities
	 *            A Hashtable which contains the probability values
	 * @param states
	 *            A Vector which is the model states
	 * @return Normalized probabilities as a Hashtable
	 */

	public Vector<Hashtable<String, Double>> normalize(Vector<Hashtable<String, Double>> probabilities,
