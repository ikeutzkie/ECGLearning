package ECGLearning.src.baumWelch.DA.Processing;
...
public class DataDecoding {
	 ...
	 * 
	 * @param nameInJson
	 *            A string that hold the json expression of the model name
	 ...
	 * 
	 * @param dateInJson
	 *            A string that hold the json expression of the model creation
	 *            date
	 ...
	 * 
	 * @param purposeInJson
	 *            A string that hold the json expression of the model purpose
	 ...
	 * 
	 * @param statesInJson
	 *            A string that hold the json expression of the model states
	 ...
	 * 
	 * @param initialProbabilitiesInJson
	 *            A string that hold the json expression of the model initial
	 *            probabilities
	 ...
	 * 
	 * @param observationsInJson
	 *            A string that hold the json expression of the model
	 *            observations
	 ...
	 * 
	 * @param transitionMatrixInJson
	 *            A string that hold the json expression of the model transition
	 *            matrix
	 ...
	 * 
	 * @param emissionMatrixInJson
	 *            A string that hold the json expression of the model emission
	 *            matrix
